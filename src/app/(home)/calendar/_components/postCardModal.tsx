...
export default function PostCardModal({
  ...
  return (
    <Dialog open={true} onOpenChange={() => setSelectedPost(null)}>
      <DialogContent className="mx-2 my-2 max-h-[95vh] w-[calc(100vw-1rem)] max-w-sm overflow-hidden dark:border-gray-700 sm:mx-4 sm:my-4 sm:w-full sm:max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-6xl">
        <DialogHeader>
        ...
        <div className="flex-1 overflow-y-auto px-1">
          <div className="grid h-full grid-cols-1 gap-4 md:gap-6 xl:grid-cols-2">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg border bg-gray-50 p-3 dark:bg-gray-900/50 md:p-4">
                {renderPreview ? (
                  renderPreview()
                ) : (
